...
os.environ["NEO4J_PASSWORD"] = "GF@yq.1311"
...
def create_graph():
    ...
    db_file_path = 'file:///assert/movies_small.csv'
...
llm = ChatOllama(model="qwen3.5", temperature=0, verbose=True)  # llama3.1查不出内容；EntropyYue/chatglm3生成的查询有问题报错
